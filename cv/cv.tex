...
\section{TECHNOLOGIES}
   \begin{itemize}
   \item
     C++: 6+ years of experience writing using the \href{https://google.github.io/styleguide/cppguide.html}{Google C++ Style Guide}.
   \item 
...
\vspace{0.2in}
   \begin{itemize}
     \item Developing features at Google scale and mentoring multiple FTEs.
     \item Gained familiarity with the technical design that powers much of YouTube.
 \end{itemize}
