...
I'm a C++ developer at YouTube (Google). I mostly build viewer-facing features
for various RPC-based C++ frontends. I often work vertically
across the organization, so good collboration skills have been the key to my
success.

\section{TECHNOLOGIES}
   \begin{itemize}
   \item
     C++: 6+ years of using the \href{https://google.github.io/styleguide/cppguide.html}{Google C++ Style Guide}.
   \item 
...
\vspace{0.2in}
   \begin{itemize}
     \item Feature development at Google scale and mentoring multiple FTEs.
     \item Learned the technical design that powers much of YouTube.
 \end{itemize}
